...
function Back() {
    return (
        ...
        <div className="container -mx-8 flex flex-wrap  flex-col md:flex-row items-center -mt-2  " >
          <Link className="flex title-font font-medium mr-14 items-center text-gray-900  mb md:mb-0" to='/'>
      ...
      <Link className="flex ml-auto mb-4 text-white bg-black  py-1 rounded-full  px-20 focus:outline-none hover:bg-white hover:text-black" to="/">Back  
